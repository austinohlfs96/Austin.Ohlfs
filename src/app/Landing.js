...
const LandingPage = () => {
  ...
  <p style={{ fontSize: isMobile ? '2.4vw' : '1.5vw', width: '50%', marginTop: isMobile ? '50px' : '150px', marginBottom: isMobile ? '20px' : '60px', fontStyle: 'italic', fontFamily: 'serif'}} className="fadeInLeftToRight">
